...
\projectC{}. These data come form real world projects and have fundamental
details such as: number of work packages, required skills and staff.  Figure
\ref{fig:dag} shows the dependency graph that illustrates the dependencies among
...
well as a few internal applications \cite{ren2}. The details of the projects is
shown in Table \ref{tab:statis}.
