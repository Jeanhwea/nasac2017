...
\begin{figure}[!ht]
  \centering
  \subfigure[\projectA{} Details, $33$ work packages, $4$ resources and $33$ dependencies]{
    \centering
    \label{fig:dag:a} 
    \includegraphics[width=0.85\textwidth]{figures/a.eps}
  }
  \subfigure[\projectB{} Details, $106$ work packages, $8$ resources and $105$ dependencies]{
    \centering
    \label{fig:dag:b}
    \includegraphics[width=\textwidth]{figures/b.eps}
  }
  \subfigure[\projectC{} Details, $74$ work packages, $14$ resources and $73$ dependencies]{
    \centering
    \label{fig:dag:c}
...
Each generation of the boxplot diagram shows the five statistical data of all
