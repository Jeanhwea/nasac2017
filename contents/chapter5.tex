...
\begin{figure}[!ht]
  \centering
  \subfigure[\projectA{}'s Details, $33$ work packages, $4$ resources and $33$ dependencies]{
    \centering
    \label{fig:dag:a} 
    \includegraphics[width=0.8\textwidth]{figures/a.eps}
  }
  \subfigure[\projectB{}'s Details, $106$ work packages, $8$ resources and $105$ dependencies]{
    \centering
    \label{fig:dag:b}
    \includegraphics[width=\textwidth]{figures/b.eps}
  }
  \subfigure[\projectC{}'s Details, $74$ work packages, $14$ resources and $73$ dependencies]{
    \centering
    \label{fig:dag:c}
...
\begin{figure}[!h]
  ...
  \subfigure[\projectA{}'s solution converges on \emph{19th} generation]{
    \label{fig:pj:a} 
    \includegraphics[width=.75\textwidth]{figures/fig_pa1.eps}
  }

  \subfigure[\projectB{}'s solution converges on \emph{22rd} generation]{
    \label{fig:pj:b} 
    \includegraphics[width=.75\textwidth]{figures/fig_pa2.eps}
  }

  \subfigure[\projectC{}'s solution converges on \emph{15th} generation]{
    \label{fig:pj:c} 
    \includegraphics[width=0.75\textwidth]{figures/fig_pa3.eps}
  }
  \caption{Statistics of Fitness Value in Each Generation}
  \label{fig:pj}
\end{figure}

Each generation of the boxplot diagram shows the five kinds of statistical data
...
\begin{figure}[!hb]
  \centering
  \subfigure[\projectA{}'s time spend on CPU is \emph{1.80} times than on GPU]{
    \label{fig:co:a}
    \includegraphics[width=0.8\textwidth]{figures/fig_co1.eps} }
  \subfigure[\projectB{}'s time spend on CPU is \emph{2.10} times than on GPU]{
    \label{fig:co:b}
    \includegraphics[width=0.8\textwidth]{figures/fig_co2.eps} }
  \subfigure[\projectC{}'s time spend on CPU is \emph{2.00} times that on GPU]{
    \label{fig:co:c}
...
on CPU is roughly twice as long as the parallel algorithm on GPU. So it can be a
good answer to \textbf{RQ2} that parallel evolutionary algorithm can improve the
